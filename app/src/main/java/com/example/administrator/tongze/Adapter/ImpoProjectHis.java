...
public class ImpoProjectHis extends RecyclerView.Adapter<ImpoProjectHis.ViewHolder> {
    private String TAG = "ExperienceAdapter";
    private int CAN_SEE = 0;
    private int status;
    private Context mContext;
    private List<PaseExperienceList.DataBean.ImpoProjectHisBean> list;


   public ImpoProjectHis(List<PaseExperienceList.DataBean.ImpoProjectHisBean> lists, Context context){
       this.list = lists;
       this.mContext = context;
   }

    public ImpoProjectHis.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ImpoProjectHis.ViewHolder holder, int position) {
        PaseExperienceList.DataBean.ImpoProjectHisBean bean = list.get(position);
