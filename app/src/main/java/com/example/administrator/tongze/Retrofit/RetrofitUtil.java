...
import com.example.administrator.tongze.BuildConfig;
...
public class RetrofitUtil {
    ...
    public static final String HOST = "https://happybikeapi.cyi365.com/Tongze/public/";
    ...
    public static StandingCommitteeService getService(){
        if(apiService == null){
            apiService =  retrofit.create(StandingCommitteeService.class);
        }
        return apiService;
    }
